...
const defaultProducts = [
  { id: 'p1', name: 'Букет "Нежность"', composition: 'Розы, пионы, эвкалипт', price: 3500, type: 'букет', occasion: 'день рождения', image: '' },
  { id: 'p2', name: 'Роза красная', composition: 'Одна роза', price: 500, type: 'цветок', occasion: 'любой', image: '' },
  { id: 'p3', name: 'Букет "Свадебный"', composition: 'Белые розы, фрезии', price: 4500, type: 'букет', occasion: 'свадьба', image: '' },
  { id: 'p4', name: 'Композиция "Осень"', composition: 'Хризантемы, ягоды', price: 2800, type: 'композиция', occasion: 'благодарность', image: '' },
]

const defaultMasterClasses = [
  { id: 'm1', theme: 'Основы флористики', date: '2026-05-15', price: 2000, places: 10, description: 'Научитесь составлять букеты', image: '' },
  { id: 'm2', theme: 'Свадебная флористика', date: '2026-05-20', price: 3000, places: 8, description: 'Букет невесты и бутоньерка', image: '' },
  { id: 'm3', theme: 'Цветочные композиции', date: '2026-06-01', price: 2500, places: 12, description: 'Создаём интерьерные композиции', image: '' },
]
